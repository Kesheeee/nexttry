...
const plans = [
  {
    ...
    features: ['nCall (5 messages/day)', 'Community connects', 'Event access'],
    accent: '#6c5ce7',
    current: true,
  },
  {
    ...
    features: ['Unlimited nCall', 'Priority event booking', 'Mentor matching', 'Profile verification badge', 'Podcast early access'],
    accent: '#6c5ce7',
    current: false,
    popular: true,
  },
