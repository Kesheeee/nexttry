...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'dash.promptSub': 'Ask nCall — your AI mentor is ready.',
  ...
  zh: {
    ...
    'dash.promptSub': '問 nCall — 你的 AI 導師已準備就緒。',
